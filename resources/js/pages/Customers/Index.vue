<template>
  <div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
      ...
      <ResourceTable :fields="fields" resource-name="customers" />
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const fields = [
      { label: 'Name', name: 'first_name', sortable: true },
      { label: 'Company Name', name: 'company_name', sortable: true },
      ...
      { label: 'Work Phone', name: 'work_phone' },
      {
        ...
        name: 'receivables',
        computed: resource => {
          return formatter.format(resource.receivables)
        }
      }
    ]
